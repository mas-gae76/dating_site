"""
Django settings for meeting_site project.
...
ROOT_URLCONF = 'meeting_site.urls'
...
WSGI_APPLICATION = 'meeting_site.wsgi.application'
...
WATERMARK_PATH = os.path.join(BASE_DIR, 'static/watermark.jpg')
